...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s fuckthemheggiescoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  fuckthemheggiescoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded fuckthemheggiescoin transaction") + "\n" +
              "  fuckthemheggiescoin-tx [options] -create [commands]   " + _("Create hex-encoded fuckthemheggiescoin transaction") + "\n" +
              "\n";
