...
#if defined(NDEBUG)
# error "Fuckthemheggiescoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Fuckthemheggiescoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s FTHT additional fees, %d delta bytes\n",
