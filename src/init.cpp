...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/fuckthemheggiescoin-project/fuckthemheggiescoin>";
    const std::string URL_WEBSITE = "<https://fuckthemheggiescoin.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Fuckthemheggiescoin version %s\n", FormatFullVersion());
}
